...
public class BuyAndSellWithCoolDownTest {
    ...
    private BuyAndSellWithCoolDownGeeks calculator1 = new BuyAndSellWithCoolDownGeeks();
    ...
    public void test1() {
        ...
        var maxProfit = calculator1.maxProfit(prices);
    ...
    public void test205() {
        ...
        var maxProfit = calculator1.maxProfit(prices);
        Assert.assertEquals(428, maxProfit);
